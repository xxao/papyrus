...
HK_ARTICLES_OPEN_PDF = "Ctrl+Shift+O"
ACCELERATORS.append((wx.ACCEL_CTRL | wx.ACCEL_SHIFT, ord("O"), ID_ARTICLES_OPEN_PDF))

HK_ARTICLES_OPEN_DOI = "Ctrl+Shift+W"
ACCELERATORS.append((wx.ACCEL_CTRL | wx.ACCEL_SHIFT, ord("W"), ID_ARTICLES_OPEN_DOI))

HK_ARTICLES_OPEN_PMID = "Ctrl+Shift+P"
ACCELERATORS.append((wx.ACCEL_CTRL | wx.ACCEL_SHIFT, ord("P"), ID_ARTICLES_OPEN_PMID))

HK_ARTICLES_REVEAL_PDF = "Ctrl+Shift+R"
ACCELERATORS.append((wx.ACCEL_CTRL | wx.ACCEL_SHIFT, ord("R"), ID_ARTICLES_REVEAL_PDF))
...
HK_ARTICLES_RESTORE = "Ctrl+R"
ACCELERATORS.append((wx.ACCEL_CTRL, ord("R"), ID_ARTICLES_RESTORE))
